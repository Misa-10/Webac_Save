...
$Number_of_dir = NULL; $Size_png = NULL; $Size_png_zero =NUll;
#Launch my code
Options();
#Gestions D'erreur -o
...
function Get_global_width_height(){
    ...
    for ($i=0; $i <=$Number_of_png-1 ; $i++) { # start at 0 cause array start at 0
        ...
        if ($global_width<$Size_png_global[0]) { // if the height of png png is the most big then we save it
            
            $global_width = $Size_png_global[0];
            
        }
        if (array_key_exists("o",$options)==true && $options["o"]==true) {
            $global_height+=$options["o"];
            $global_width = $options["o"];
        }
        elseif (array_key_exists("override-size",$options)==true && $options["override-size"]==true) {
            $global_height+=$options["override-size"];
            $global_width = $options["override-size"];
        }
        else {
    ...
    if (array_key_exists("p",$options)==true)
    {
        ...
        $global_height = $global_height + $Padding_all;
...
function Fusion_image(){
    ...
    global $global_width; global $global_height; global $Handle; global $img_name; global $Size_All; global $Size_png_zero; global $Size_png;
    ...
    for ($i=1; $i <=$Number_of_png-1 ; $i++) {  # start at 1 cause we already did the 0 png of the array
        ...
        if ($i==1) {
            ...
            if (array_key_exists("p",$options)==true)
            {
                $Size_png_zero_resize[1]=$Size_png_zero_resize[1]+$options["p"];
                $Size_png_zero[1]=$Size_png_zero[1]+$options["p"];
                
            }
            elseif (array_key_exists("padding",$options)==true) {
                $Size_png_zero_resize[1]=$Size_png_zero_resize[1]+$options["padding"];
                $Size_png_zero[1]=$Size_png_zero[1]+$options["padding"];
            ...
            {
                imagecopyresampled( $Fusion_png,$PNG,0, $Size_png_zero_resize[1], 0, 0,$Size_png_resize[0],$Size_png_resize[1], $Size_png[0], $Size_png[1]);
                $Size_All = $Size_png_resize[0] + $Size_png_resize[1]; // get the larger of two first pics
                
            }
            elseif (array_key_exists("o",$options)==false  || array_key_exists("override-size",$options)==false) {
                imagecopy( $Fusion_png,$PNG, 0, $Size_png_zero[1], 0, 0, $Size_png[0], $Size_png[1]);
                $Size_All = $Size_png_zero[1] + $Size_png[1]; // get the larger of two first pics
        ...
        elseif ($i!=1) {
            ...
            if (array_key_exists("o",$options)==true || array_key_exists("override-size",$options)==true)
            {
                imagecopyresampled( $Fusion_png,$PNG, 0, $Size_All, 0, 0,$Size_png_resize[0],$Size_png_resize[1], $Size_png[0], $Size_png[1]);
                $Size_All += $Size_png_resize[1]; // add the larger of the new pics
            }
            elseif (array_key_exists("o",$options)==false  || array_key_exists("override-size",$options)==false) {
                
                imagecopy( $Fusion_png,$PNG, 0, $Size_All, 0, 0, $Size_png[0], $Size_png[1]);
                $Size_All += $Size_png[1]; // add the larger of the new pics
            }
...
function Fill_css($i){
    ...
    global $Handle; global $img_name; global $Size_All; global $options; global $Size_png_zero_resize; global $Size_png_resize; global $Name_Fusion_Img;
    global $Size_png_zero; global $Size_png;
    ...
    if (strpos($img_name, " ")==false) {
        ...
        if (array_key_exists("o",$options)==true || array_key_exists("override-size",$options)==true)
        {
            ...
            if ($i==NULL) {
                ...
                fwrite($Handle,".img-$img_name {width: $Size_png_zero_resize[0]px; height: $Size_png_zero_resize[1]px;
                    background: url('$Name_Fusion_Img') -0 -0px;");
                    Padding_css();
                ...
                elseif ($i==1) {
                    ...
                    fwrite($Handle,".img-$img_name {width: $Size_png_resize[0]px; height: $Size_png_resize[1]px;
                        background: url('$Name_Fusion_Img') -0 -$Size_png_zero_resize[1]px;");
                        Padding_css();
                    ...
                    elseif ($i!=1) {
                        ...
                        fwrite($Handle,".img-$img_name{width: $Size_png_resize[0]px; height: $Size_png_resize[1]px;
                            background: url('$Name_Fusion_Img') -0 -$Size_All"."px;");
                            Padding_css();
                    ...
                    elseif (array_key_exists("o",$options)==false || array_key_exists("override-size",$options)==false) {
                        ...
                        if ($i==NULL) {
                            ...
                            fwrite($Handle,".img-$img_name {width: $Size_png_zero[0]px; height: $Size_png_zero[1]px;
                                background: url('$Name_Fusion_Img') -0 -0px;");
                                Padding_css();
                            ...
                            elseif ($i==1) {
                                ...
                                fwrite($Handle,".img-$img_name {width: $Size_png[0]px; height: $Size_png[1]px;
                                    background: url('$Name_Fusion_Img') -0 -$Size_png_zero[1]px;");
                                ...
                                echo "$Red_Color_Start Erreur : $img_name ne peux pas contenir d'espace dans le nom.
                Le script va fonctioné mais votre image va être retirer du css. $Color_End\n";
                            }
                        }
...
function Padding_css()
                        {
                            
                            global $options;global $Handle;
